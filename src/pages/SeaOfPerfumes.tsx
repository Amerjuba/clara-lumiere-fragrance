...
type Subcategory = 'all' | 'for-her' | 'for-him' | 'oriental';
...
const SeaOfPerfumes = () => {
  ...
  const seaProducts = products.filter(p => p.category === 'Sea of Perfumes');

  return (
    <>
      <Helmet>
        <title>Sea of Perfumes | Clara Lumiere - Ocean-Inspired Fragrances</title>
        <meta name="description" content="Explore our ocean-inspired scent collection. Fresh, invigorating fragrances that capture the essence of coastal luxury." />
      </Helmet>
        ...
        <section className="py-20 bg-gradient-to-b from-primary/5 to-background">
          <div className="container text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Ocean-inspired scents that transport you to sun-kissed shores and Mediterranean breezes.
            </p>
          </div>
        </section>
