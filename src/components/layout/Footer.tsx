...
const Footer = () => {
  ...
  return <footer className="bg-primary text-primary-foreground" id="contact">
      <div className="container py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* Brand */}
          <div className="lg:col-span-2">
            <h3 className="text-2xl font-serif mb-4 text-accent">Clara Lumiere</h3>
            <p className="max-w-md leading-relaxed mb-6 text-accent">
          ...
          <div className="text-accent">
            ...
            <ul className="space-y-3 text-accent">
              {['Signature Scents', 'Sea of Perfumes', 'Oriental Oils', 'Royal Fragrance'].map(item => <li key={item}>
                  <a href="#products" className="transition-colors duration-300 text-accent">
                    {item}
                  </a>
                </li>)}
            </ul>
          ...
          <div className="text-accent">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+4797287889" className="transition-colors text-accent">
                  +47 972 878 89
                </a>
              </li>
              <li className="flex items-start gap-3">
                <Mail className="h-4 w-4 mt-1 shrink-0" />
                <a href="mailto:info@claralumiere.com" className="transition-colors text-accent">
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6 text-sm text-accent">
              <a href="#" className="transition-colors text-accent">
                Privacy Policy
              </a>
              <a href="#" className="transition-colors text-accent">
                Terms of Service
