...
const Header = () => {
  ...
  const productCategories = [
    { name: 'Signature Scents', href: '/signature-scents' },
    { name: 'Sea of Perfumes', href: '/sea-of-perfumes' },
    { name: 'Oriental Oils', href: '/oriental-oils' },
    { name: 'Make Your Own Brand', href: '/make-your-own-brand' },
      ...
      <div className="container">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center">
            <img src={logo} alt="Clara Lumiere" className="h-12 w-auto" />
          </Link>
