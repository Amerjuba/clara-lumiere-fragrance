    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="container relative z-10 pt-20">
        <div className="max-w-2xl">
          <span 
            className="inline-block text-accent font-medium uppercase tracking-[0.3em] text-sm mb-6"
            style={{ 
          ...
          <h1 
            className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-serif leading-tight mb-6"
            style={{ 
              color: '#f8f7f4',
